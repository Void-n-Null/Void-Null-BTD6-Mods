...
namespace VoidNull
{
    ...
    {
        public static TowerModel BaseAthleteMonkey => Game.instance.model.GetTowerFromId("AthleteMonkey");
        public static string AthleteMonkeyDisplay => BaseAthleteMonkey.display;
        ...
        public static void SetTexture(this UnityDisplayNode node, string fileName)
        {
            foreach (Renderer genericRenderer in node.genericRenderers)
                genericRenderer.material.mainTexture = GetTexture<MainMod>(fileName);
        }
